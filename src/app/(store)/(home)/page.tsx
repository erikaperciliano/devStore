  ...
  return (
    <div className="grid max-h-[860px] grid-cols-9 grid-rows-6 gap-6">
      <Link href='/' className="group relative col-span-6 row-span-6 rounded-lg bg-zinc-900 overflow-hidden flex justify-center items-end">
        <Image src='/moletom-ai-side.png' className="group-hover:scale-105 transition-transform duration-500"  width={860} height={920} quality={100} alt=""/>
      ...
      <Link href='/' className="group relative col-span-3 row-span-3 rounded-lg bg-zinc-900 overflow-hidden flex justify-center items-end">
        <Image src='/moletom-java.png' className="group-hover:scale-105 transition-transform duration-500" width={860} height={920} quality={100} alt=""/>
